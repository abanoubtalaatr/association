        ...
        <div class="border-div">
            ...
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="row b-div">
                                    ...
                                    <div class="col-md-6">
                                        <div class="ad-det">
                                            ...
                                            <p>{{\App\Services\StatsService::totalClicksForAd($record)}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="ad-det">
                                            <div class="h6">
                                                <span>@lang('site.number_of_clicks_user_make_it')</span>
                                            </div>
                                            <p>{{$record->clicks}}</p>
                                        </div>
                                    </div>
                    ...
                    <div class="box-det mt-30">
                        <div class="task-head">
                            <h6 class="mb-4">@lang('general.total_time_for_ad')
                        ...
                        <div class="task-body">
                            @if(isset($time) && !empty($time))
                                <span>{{ceil($time/60) }} @lang('general.minute')</span>@endif
                        </div>
                    ...
                    <div class="box-det mt-30">
                        <div class="task-head">
                            <h5>@lang('general.operating_system')</h5>
                        </div>
                        <div class="task-body">

                            <div class="ad-details">
                                <div class="row b-div">
                                    @foreach($operating_system as $operating)
                                        <div class="col-md-6">
                                            <div class="ad-det">
                                                <div class="h6">
                    ...
                    <div class="box-det mt-30">
                        <div class="task-head">
                            <h5>@lang('general.targeted_audience')</h5>
                        </div>
                        <div class="task-body">
